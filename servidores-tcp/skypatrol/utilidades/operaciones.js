 ...
 */
 ...
 function obtenerImeiGps(data) {
     ...
     let trama_ascii_separada_imei = trama_ascii_separada[0].split(" ");
     let trama_inicial = trama_ascii_separada_imei.filter(Boolean);
 
     //imei esta en la posicion 1
     let imei =  trama_inicial[2];
  ...
  * @param {*} data 
  */
 function ObtenerInformacionGps(data, imei) {
     let trama_binario =[];
     ...
     //codigo esta en la posicion 1
     let codigo_gps =  trama_inicial[1];
     //se inicializa con el estado del motor
     let acc =vehiculo.estado_vehiculo.estado_motor;
     //se inicializa con el estado de la bateria
     let bateria =vehiculo.estado_vehiculo.estado_bateria_vehiculo;
 
     //si el codigo es 22 significa que se encendio el vehiculo
     if (codigo_gps==22) {
         acc = 1; 
     }  
 
     //si el codigo es 23 significa que se apago el vehiculo
     if (codigo_gps==23) {
         acc = 0; 
     }
     //si el codigo es 78 significa que se desconecto la bateria del vehiculo
     if (codigo_gps==78) {
         bateria =0;
     }  
     //si el codigo es 78 significa que se conecto la bateria del vehiculo
     if (codigo_gps==79) {
        bateria =1; 
     }
 
     //si es 61 se activa el panico 0 activa el panico
     let panic =codigo_gps==61 ? 0 :1;
 ...
 function obtenerFecha(data) {
     ...
     let YY = fecha.substring(4,6).padStart(2, '0');
 ...
 function obtenerLatitud(data) {
  ...
  //   let lat1=data[2].substring(0,2);
  //   let lat2=data[2].substring(2,9);
 ...
 /*
     let longi1= data[4].substring(0,3);
     let longi2= data[4].substring(4,10);
 ...
 function obtenerVelocidad(data) {
     //obtener velocidad
     let velocidad_nudos = data[21];
     let velocidad_km =parseFloat(velocidad_nudos)*1.852; 
     
     return parseInt(velocidad_km);
 }
