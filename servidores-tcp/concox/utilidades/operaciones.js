 ...
 */
 ...
 function ObtenerInformacionGps(data, socket, tipo='latido') {
     ...
     console.log('protocolo_de_alerta', protocolo_de_alerta);
 ...
 function obtenerAlertaLenguajeGps(data, tipo) {
     ...
     switch (trama1) {
        ...
        //alerta_de_velocidad
         case 6:  
         protocolo_alerta=9999;
         descripcion_protocolo_alerta='alerta_de_velocidad';
 ...
 function obtenerDetectorInformacion(data) {
    // obtener tipo de detector 
    let tipo_detector= data[5].toString(16).padStart(2, '0');
    let alerta_puerta = null;
    let alerta_voltaje = null;
    let trama='';

    switch (tipo_detector) {
        //alerta de voltaje
        case '00':
            let trama1 = data[6].toString(16).padStart(2, '0');
            let trama2 = data[7].toString(16).padStart(2, '0');

            trama= ''+trama1+trama2;
            //obtener voltaje 
            alerta_voltaje=(parseInt(trama,16)/100);  

            
            break; 
        //alerta de puerta
        case '05':
            trama= data[6].toString(16);
            alerta_puerta = parseInt(trama,16);  
            break;
 ...
 function obtenerCantidadSatelites(data) {
    ...
    let data_convertida = data.toString(16).padStart(2, '0');
 ...
 function obtenerEstadoMotor(data) {
    
    let trama1;
 
    trama1= data[30].toString(16);
        
    let estatus=parseInt(trama1,16);
 ...
 exports.obtenerDetectorInformacion=obtenerDetectorInformacion;
 exports.obtenerEstadoMotor=obtenerEstadoMotor;
